...
const cardsContainer = document.getElementById('cardsContainer'); // Reemplaza 'cardsContainer' con el ID real de tu contenedor HTML

cardsContainer.innerHTML = juegos.map((juego) => `
    <div class="card mb-3">
